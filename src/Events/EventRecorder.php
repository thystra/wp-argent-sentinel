	...
	public function record( string $event_type, string $severity, string $outcome, array $attributes = array() ): bool {
		try {
			...
			$event_attributes = array(
				'source_ip'         => array_key_exists( 'source_ip', $attributes )
				...
				'user_agent'        => array_key_exists( 'user_agent', $attributes )
					...
					: $request->userAgent(),
				'request_method'    => array_key_exists( 'request_method', $attributes )
					? $attributes['request_method']
					: $request->method(),
				'request_path'      => array_key_exists( 'request_path', $attributes )
